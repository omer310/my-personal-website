  ...
  return (
    <section id="story" className="py-16">
      <div className="container mx-auto px-4">
        <div className="bg-white bg-opacity-90 dark:bg-gray-800 dark:bg-opacity-90 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-8">
          <motion.h2 
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
            ...
            >
              <div className="w-64 h-64 mx-auto overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
          ...
          >
            ...
            <div className="relative border-l-2 border-blue-500 ml-3 pl-6">
